...
export const ListingsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createListing: async (body?: CreateListing, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        deleteListing: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling deleteListing.');
            }
         ...
         * @throws {RequiredError}
         */
        updateListing: async (body?: UpdateListing, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/listing`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const ListingsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createListing(body?: CreateListing, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ListingFull>>> {
            const localVarAxiosArgs = await ListingsApiAxiosParamCreator(configuration).createListing(body, options);
         ...
         * @throws {RequiredError}
         */
        async deleteListing(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ListingFull>>> {
            const localVarAxiosArgs = await ListingsApiAxiosParamCreator(configuration).deleteListing(id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getListing(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ListingFull>>> {
            const localVarAxiosArgs = await ListingsApiAxiosParamCreator(configuration).getListing(id, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateListing(body?: UpdateListing, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ListingFull>>> {
            const localVarAxiosArgs = await ListingsApiAxiosParamCreator(configuration).updateListing(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ListingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createListing(body?: CreateListing, options?: AxiosRequestConfig): Promise<AxiosResponse<ListingFull>> {
            return ListingsApiFp(configuration).createListing(body, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a listing by ID.
         * @summary Delete an existing listing.
         ...
         * @throws {RequiredError}
         */
        async deleteListing(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<ListingFull>> {
            return ListingsApiFp(configuration).deleteListing(id, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a listing by ID
         * @summary Retrieve an existing listing
         ...
         * @throws {RequiredError}
         */
        async getListing(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<ListingFull>> {
            return ListingsApiFp(configuration).getListing(id, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Retrieve any listings matching a filter
         ...
         * @throws {RequiredError}
         */
        async updateListing(body?: UpdateListing, options?: AxiosRequestConfig): Promise<AxiosResponse<ListingFull>> {
            return ListingsApiFp(configuration).updateListing(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ListingsApi extends BaseAPI {
     ...
     */
    public async createListing(body?: CreateListing, options?: AxiosRequestConfig) : Promise<AxiosResponse<ListingFull>> {
        return ListingsApiFp(this.configuration).createListing(body, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Delete a listing by ID.
     * @summary Delete an existing listing.
     ...
     * @memberof ListingsApi
     */
    public async deleteListing(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<ListingFull>> {
        return ListingsApiFp(this.configuration).deleteListing(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Get a listing by ID
     * @summary Retrieve an existing listing
     ...
     * @memberof ListingsApi
     */
    public async getListing(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<ListingFull>> {
     ...
     * @memberof ListingsApi
     */
    public async updateListing(body?: UpdateListing, options?: AxiosRequestConfig) : Promise<AxiosResponse<ListingFull>> {
        return ListingsApiFp(this.configuration).updateListing(body, options).then((request) => request(this.axios, this.basePath));
    }
}
