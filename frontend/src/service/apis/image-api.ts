...
export const ImageApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async imageIdGet(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Blob>>> {
         ...
         * @throws {RequiredError}
         */
        async imagePost(body?: Object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Image>>> {
            const localVarAxiosArgs = await ImageApiAxiosParamCreator(configuration).imagePost(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ImageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async imagePost(body?: Object, options?: AxiosRequestConfig): Promise<AxiosResponse<Image>> {
            return ImageApiFp(configuration).imagePost(body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ImageApi extends BaseAPI {
     ...
     * @memberof ImageApi
     */
    public async imagePost(body?: Object, options?: AxiosRequestConfig) : Promise<AxiosResponse<Image>> {
        return ImageApiFp(this.configuration).imagePost(body, options).then((request) => request(this.axios, this.basePath));
    }
}
